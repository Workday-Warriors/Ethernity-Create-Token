...
export const Header = () => {
  ...
  return (
    <div className='w-full px-10 flex justify-end items-center h-[100px] fixed top-0 left-0  bg-transparent'>
      <div className='w-full lg:w-auto flex gap-x-8'>
        <button
        ...
        >
          ...
          <span className='relative inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-white transition-all duration-200 bg-gray-900 font-pj rounded-xl focus:outline-none'>
            Launch App
          </span>
        </button>
